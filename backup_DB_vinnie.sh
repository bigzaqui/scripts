...
usage() { 
	...
	echo "option=full: do a full backup of /var/lib/mysql using innobackupex, aprox time 6 hours."
	echo "option=incremental: do a incremental backup"
	echo "option=restore: this will restore the latest backup, BE CAREFUL!"
...
#BACKUP_DIR=/mnt/backup/database/raw
BACKUP_DIR=/mnt/backup/database/raw
